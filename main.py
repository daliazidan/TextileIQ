...
def home():
    ...
    prompt = f"""
        The user is shopping from {brand}, a fast-fashion brand.
        Suggest 3 ethical and sustainable clothing alternatives.
        For each alternative, just provide the name and link to the website
        """
    ...
    alternatives = response.output_text
    print(alternatives)
...
def flipbook():
    ...
    if request.method == 'POST':
        flipbook_desc = request.form['description']
        language = request.form['language']
        length = int(request.form['pages'])
        ...
        receiver_email = "daliahqzidan@gmail.com"  # Recipient's email address
        subject = "Sustainability Flipbook"
